...
SYSTEM_PROMPT = (
    "You are the library assistant for Shenzhen University. "
    "Answer questions about library locations, branches, and addresses. "
...
def handle(message: str) -> SkillResult:
    ...
    try:
        ...
        response = f"The library skill could not answer right now: {exc}"
        status = "error"
