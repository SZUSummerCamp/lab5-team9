...
SYSTEM_PROMPT = (
    "You are the campus assistant for Shenzhen University. "
    "Answer questions about campus facts such as the university name, motto, "
    "founding year, and campuses. "
...
def handle(message: str) -> SkillResult:
    ...
    try:
        ...
        response = f"The campus skill could not answer right now: {exc}"
        status = "error"
